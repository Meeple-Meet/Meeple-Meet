...
// For now there's no high contrast colors defined as this may not be a feature we're that interested in developing.
// Either way, the code is modular such that we only have to add the colors here and we're good to go.
