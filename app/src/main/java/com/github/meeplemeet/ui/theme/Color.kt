...
// Define all the colors for light and dark themes (and potentially others)
// , made to match with Figma design
...
val TextIconsFadeLight = Color(0xCC000000)  // Secondary text and icons (disabled state, less emphasis)
...
val TextIconsFadeDark = Color(0xCCFFFFFF)   // Secondary text and icons (disabled state, less emphasis)
