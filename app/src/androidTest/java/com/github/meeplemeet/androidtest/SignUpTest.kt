...
class SignUpTest {
  ...
  fun test_sign_up_with_invalid_email_shows_error() {
    ...
    composeTestRule.onNodeWithTag("confirm_password_field").performTextInput(testPassword)
  ...
  fun test_sign_up_with_empty_fields_shows_validation_errors() {
    ...
    composeTestRule
        .onNodeWithText("Please confirm your password", substring = true)
        .assertIsDisplayed()
  ...
  fun test_google_sign_up_button_click() {
    ...
    composeTestRule.onNodeWithTag("google_sign_up_button").performClick()
  ...
  fun test_password_visibility_toggles() {
    ...
    composeTestRule.onNodeWithTag("password_visibility_toggle").assertIsDisplayed().performClick()

    // Test confirm password field visibility toggle
    composeTestRule
        .onNodeWithTag("confirm_password_visibility_toggle")
        .assertIsDisplayed()
        .performClick()
  ...
  fun test_real_time_password_validation() {
    ...
    composeTestRule.onNodeWithTag("confirm_password_field").performClick()
  ...
  fun test_real_time_password_confirmation_validation() {
    ...
    composeTestRule.onNodeWithTag("confirm_password_field").performTextInput("DifferentPassword")
  ...
  fun test_form_data_persistence_during_errors() {
    ...
    composeTestRule.onNodeWithTag("email_field").assertTextContains(invalidEmail)
    composeTestRule.onNodeWithTag("password_field").assertTextContains(testPassword)
    composeTestRule.onNodeWithTag("confirm_password_field").assertTextContains(testPassword)
  }
