  ...
  fun all_tests() = runBlocking {
    ...
    checkpoint("Tap 'Create poll'") {
      composeTestRule.waitUntilAtLeastOneExists(
          matcher = hasTestTag(DiscussionTestTags.ATTACHMENT_POLL_OPTION))
    ...
    composeTestRule.onNodeWithTag(DiscussionTestTags.QUESTION_FIELD).performTextInput("Pick snacks")
    ...
    // select two options
    composeTestRule
        .onNodeWithTag(DiscussionTestTags.pollVoteButton(multiMsgIndex, 0), useUnmergedTree = true)
        .performClick()
    composeTestRule.waitForIdle()
    composeTestRule
        .onNodeWithTag(DiscussionTestTags.pollVoteButton(multiMsgIndex, 2), useUnmergedTree = true)
        .performClick()
    composeTestRule.waitForIdle()
