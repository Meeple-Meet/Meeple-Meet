...
echo "🔍 Checking for repeated string literals in com.github.meeplemeet package..."
echo ""
...
if [ -s "$TEMP_FILE" ]; then
  while IFS='|' read -r file string count; do
    ...
    echo -e "${RED}✗ Repeated string in: ${file#*/}${NC}"
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
if [ $ERRORS -eq 0 ]; then
  echo -e "${GREEN}✓ No repeated string literals detected!${NC}"
  exit 0
else
  echo -e "${RED}✗ Found repeated strings in $ERRORS file(s)${NC}"
  echo ""
  echo "Repeated string literals should be extracted as constants."
  echo ""
  echo "Example:"
  echo '  ❌ Text("Welcome"), Text("Welcome"), Text("Welcome")'
  echo '  ✅ private const val WELCOME_TEXT = "Welcome"'
