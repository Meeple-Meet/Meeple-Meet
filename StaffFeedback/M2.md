...
You qualified for a Blue Belt 🥋🔵 and got a final grade of 5.37/6 for M2. Excellent work! You're demonstrating advanced skills. 
...
|------------------------------------------|--------------------------------|------------|-------------------------------------------|
| **Implementation (APK, code quality)**   | 5.29 out of 6 | 40%        | [See Details](#implementation-apk-code-quality) |
| **Features**                             | 4.91 out of 6   | 20%        | [See Details](#features)                  |
...
Bug found: replying to post, multiple times, the user gets pushed to the home page

Unrestricted Input Handling: no character limit on text input

Code Smell: check sonar cloud to find critical code smell

For this part, you received 5.29 points out of a maximum of 6.
...
GPS is requested but doesn't appear on the map and therefore isn't consider meaningful feature.
...
Significant progress are made each sprint. However feature delivery could be smoother and more stable.

For this part, you received 5.5 points out of a maximum of 6.

## Summary

Your team grade for milestone M2 is 5.37/6. If you are interested in how this fits into the bigger grading scheme, please see [project README](https://github.com/swent-epfl/public/blob/main/project/README.md) and the [course README](https://github.com/swent-epfl/public/blob/main/README.md).
